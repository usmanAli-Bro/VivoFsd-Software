    ...
    public partial class Vendor : Form
    {
        ...
        private void newbutton_Click(object sender, EventArgs e)
        {
            ...
            using(SqlConnection con = new SqlConnection(constrng)){
                using (SqlCommand cmd = new SqlCommand("SELECT [dbo].[NETVENDOR]()",con))
                {
                    con.Open();
        ...
        private void savebutton_Click(object sender, EventArgs e)
        {
            ...
            if (isvalid())
            {
                ...
                using (SqlConnection con = new SqlConnection(constrng))
                {
                    using (SqlCommand cmd = new SqlCommand("ADDVENDOR", con))
                    {
        ...
        private void Vendor_MouseClick(object sender, MouseEventArgs e)
        {
            // kkkk
        ...
        private void deletebutton_Click(object sender, EventArgs e)
        {
            if (isvalid())
            {
                ...
                using (SqlConnection con = new SqlConnection(constrng))
                {
                    using (SqlCommand cmd = new SqlCommand("DELETE FROM VENDOR WHERE CODE="+codetextBox.Text+"", con))
                    {
